        ...
        specs.append({
            ...
            "function": {
                ...
                "description": (
                    ...
                    "⭐ KUMULATIF: bila lampiran ini sudah pernah diisi di giliran SEBELUMNYA, "
                    "kolom itu TETAP ADA di file unduhan yang baru (lihat "
                    "'kolom_dari_permintaan_sebelumnya' di hasil) — user cukup memakai file "
                    "TERBARU saja. ⛔ Jangan menyuruh user menggabung sendiri, dan jangan "
                    "mengisi ulang kolom lama hanya supaya 'tidak hilang'. "
        ...
        specs.append({
            ...
            "function": {
                ...
                "description": (
                    ...
                    "⭐ KUMULATIF: kolom hasil permintaan SEBELUMNYA atas lampiran ini tetap ada "
                    "di file unduhan yang baru — user cukup memakai file TERBARU saja. "
