...
def _system_prompt(user: dict) -> str:
    ...
    agentik_block = (
        ...
        "- KAMU TIDAK BISA MELIHAT GAMBAR. Satu-satunya foto yang berguna untukmu adalah "
        "FOTO NOMOR RANGKA: server membacanya sendiri (OCR) dan yang sampai padamu sudah "
        "berupa TEKS nomor rangka. Karena itu, saat kamu MEMINTA nomor rangka, sebutkan "
        "user boleh mengetik ATAU mengirim foto nomor rangkanya. Bila user bilang sudah "
        "mengirim foto tapi di pesannya tak ada nomor rangka, minta ia memotret ulang "
        "lebih dekat & terang (jangan menebak nomornya). Untuk mengenali PART dari foto, "
