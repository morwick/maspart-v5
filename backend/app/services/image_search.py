...
def _agregasi(rows: list[dict], top_k: int, threshold: float) -> list[dict]:
    """Group per PN: foto terbaik + statistik + confidence boost → urut & potong."""
    # Untuk TAMPILAN, foto SIMS (http)
