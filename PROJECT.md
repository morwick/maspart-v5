...
| `jadwal_perawatan` | **JADWAL PERAWATAN BERKALA SHANTUI** (dozer SD16/SD22/SD32 & loader L36/L39/L55/L56/L58K/L68K) — part yang diganti tiap interval jam servis (50–2000h) + PN Shantui + qty, per sistem; dari `data/manuals/shantui Loader maintenance project periodic table.xlsx` (2026-07-16) | semua |
